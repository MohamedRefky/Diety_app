...
*/
    ...
    // Listen to local notification tap events and perform context-free routing
...
//-----water every 4 hours
  static void showbasicnotifications() async {
    ...
    if (currentTime.hour > 16) {
      await flutterLocalNotificationsPlugin.show(0, "feeling stressed ?",
          "Drinking enough water can help improve your mood 💧", details,
          payload: "payload data");
    } else {
      await flutterLocalNotificationsPlugin.show(
          0, "water ", "its time to drink water! 💦", details,
          payload: "payload data");
    }
    log("basic end");
  }
...
//local Scheduled  notifications
  static void showSchedulednotifications() async {
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      tz.TZDateTime(tz.local, 2024, 4, 30, 22, 30),
      details,
