...
class _ExerciseState extends State<Day6> {
  String? activityData;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Gap(10),
            if (D6_description1!.isNotEmpty && D6_activity1!.isNotEmpty)
              Text(
                '$D6_activity1 : $D6_duration1',
                style: TextStyle(
                    color: AppColors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold),
  ...
  Future<void> fetchActivityData() async {
    try {
      ...
      if (doc.exists) {
        ...
        if (day6 is Map<String, dynamic>) {
          if (!_isDisposed) {
            setState(() {
              // DAY 6
              D6_activity1 = day6['Activity1'] ?? ' ';
              D6_description1 = day6['Description1'] ?? ' ';
              D6_duration1 = day6['Duration1'] ?? '10 minutes';
            });
