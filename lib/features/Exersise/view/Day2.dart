...
class _ExerciseState extends State<Day2> {
  String? activityData;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Gap(10),
            if (D2_activity1 != null && D2_activity1!.isNotEmpty)
              Text(
                '$D2_activity1 : $D2_duration1',
                style: TextStyle(
                    color: AppColors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold),
  ...
  Future<void> fetchActivityData() async {
    try {
      ...
      if (doc.exists) {
        ...
        if (day2 is Map<String, dynamic>) {
          if (!_isDisposed) {
            setState(() {
              // DAY 2
              D2_activity1 = day2['Activity1'] ?? ' ';
              D2_description1 = day2['Description1'] ?? ' ';
              D2_duration1 = day2['Duration1'] ?? '10 minutes';
            });
