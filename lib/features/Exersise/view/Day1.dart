...
class _ExerciseState extends State<Day1> {
  String? activityData;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Gap(10),
            if (D1_activity1 != null && D1_activity1!.isNotEmpty)
              Text(
                '$D1_activity1 : $D1_duration1',
                style: TextStyle(
                    color: AppColors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold),
            ...
            const Gap(25),
            if (D1_activity2 != null && D1_activity2!.isNotEmpty)
              Text(
                '$D1_activity2 : $D1_duration2',
                style: TextStyle(
                    color: AppColors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold),
            ...
            const Gap(25),
            if (D1_activity3 != null && D1_activity3!.isNotEmpty)
              Text(
                '$D1_activity3  $D1_duration3',
                style: TextStyle(
                    color: AppColors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold),
