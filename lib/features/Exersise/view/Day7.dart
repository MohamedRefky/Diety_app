...
class _ExerciseState extends State<Day7> {
  String? activityData;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Gap(10),
            if (D7_activity1 != null && D7_activity1!.isNotEmpty)
              Text(
                '$D7_activity1 : $D1_duration1',
                style: TextStyle(
                    color: AppColors.white,
                    fontSize: 18,
                    fontWeight: FontWeight.bold),
